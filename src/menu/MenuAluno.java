...
public class MenuAluno extends javax.swing.JFrame {
    ...
    public void alteraInfo(String label, String self){
        AlteraInfo alterar = new AlteraInfo(uniPrincipal, infoLogin, label, self, 3);
    ...
    private void initComponents() {
        ...
        opSolicitarMatricula = new javax.swing.JMenuItem();
        ...
        jMenuItem4.setText("Dados da Universidade");
        ...
        opSolicitarMatricula.setText("Solicitar Matricula");
        opSolicitarMatricula.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                opSolicitarMatriculaActionPerformed(evt);
            }
        });
        menuMaterias.add(opSolicitarMatricula);
    ...
    private void opMinhasInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opMinhasInfoActionPerformed
        AlunoInfo alunoInfo = new AlunoInfo(uniPrincipal, self);
        desktop1.add(alunoInfo);
    ...
    private void opSolicitarMatriculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opSolicitarMatriculaActionPerformed
        SolicitacaoMatricula matricula = new SolicitacaoMatricula(uniPrincipal, self, uniPrincipal.getAluno(self).getCurso());
        desktop1.add(matricula);
        matricula.setVisible(true);
    }//GEN-LAST:event_opSolicitarMatriculaActionPerformed

    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        SolicitacaoShow solicitacao = new SolicitacaoShow(uniPrincipal, self);
        desktop1.add(solicitacao);
    ...
    private javax.swing.JMenuItem opSolicitarMatricula;
